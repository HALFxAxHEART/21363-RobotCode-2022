...
@Autonomous(name="AutoDriveColorEncoder_Right", group="Robot")
@Disabled

public class AutoDriveColorEncoder_Right extends LinearOpMode {
        ...
        //MOVE TO ZONE 1
            {telemetry.addData("Move to zone 1", "now");
               ConeLiftDrop();
                ...
                // move to the left for 2.3 second to get into zone 1
                    LeftBack.setPower(STRAFE_SPEED);
                    RightBack.setPower(-STRAFE_SPEED);
                    LeftFront.setPower(-STRAFE_SPEED);
                    RightFront.setPower(STRAFE_SPEED);
    ...
    private void ConeLiftDrop(){
        ...
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-1815);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-1815);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()+1815);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()+1815);
