...
@Autonomous(name="AutoDriveColorEncoder_Left_Side_DT", group="Robot")

public class AutoDriveColorEncoder_Left_Side_DT extends LinearOpMode {
    ...
    LiftMotor.setTargetPosition(-100);
        ...
        while (opModeIsActive() && (sensorDistance.getDistance(DistanceUnit.CM) > 1.0))
        {
            Color.RGBToHSV((int) (sensorColor.red() * SCALE_FACTOR),
            (int) (sensorColor.green() * SCALE_FACTOR),
        ...
        if(hsvValues[0] <=120 && hsvValues[0] >=35)
        ...
        //MOVE TO ZONE 1
            {telemetry.addData("Move to zone 1", "now");
               ConeLiftDrop();
                ...
                // move to the left for 2.6 second to get into zone 1
                    LeftBack.setPower(STRAFE_SPEED);
                    RightBack.setPower(-STRAFE_SPEED);
                    LeftFront.setPower(-STRAFE_SPEED);
                    RightFront.setPower(STRAFE_SPEED);
        ...
        else if(hsvValues[0] <= 185 && hsvValues[0] >= 120)
        ...
        //MOVE TO ZONE 3
            {telemetry.addData("Move to zone 3", "now");
               ConeLiftDrop();
                ...
                // move to the right for 2.5 second to get into zone 3
                    LeftBack.setPower(-STRAFE_SPEED);
                    RightBack.setPower(STRAFE_SPEED);
                    LeftFront.setPower(STRAFE_SPEED);
                    RightFront.setPower(-STRAFE_SPEED);
    ...
    private void ConeLiftDrop(){
        //Step 1. Move forward to push cone out of the way
        ...
        //Step 2. Move backward to get back to starting position
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-600);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-600);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()-600);
        ...
        //Step 3. Turn toward medium stantion
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()+1870);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()+1870);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()-1870);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()-1870);
        ...
        //Step 4. Move forward toward medium stantion
        ...
        //Step 5. Move slightly forward to position cone over stantion top
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-175);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-175);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()-175);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()-175);
        ...
        //Step 6. Move away from medium stantion
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()+755);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()+755);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()+755);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()+755);
        ...
        //Step 7. Turn away from medium stantion and lower lift
        LiftMotor.setTargetPosition(0);
        RevServo.setPosition(1);
        
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-1800);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-1800);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()+1800);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()+1800);
