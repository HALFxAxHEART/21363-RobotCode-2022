...
@Autonomous(name="AutoDriveColorEncoder_Right_Side_DT", group="Robot")

public class AutoDriveColorEncoder_Right_Side_DT extends LinearOpMode {
        ...
        //MOVE TO ZONE 3
            {telemetry.addData("Move to zone 3", "now");
               ConeLiftDrop();
                ...
                // move to the right for 2.4 second to get into zone 3
                    LeftBack.setPower(-STRAFE_SPEED);
                    RightBack.setPower(STRAFE_SPEED);
                    LeftFront.setPower(STRAFE_SPEED);
                    RightFront.setPower(-STRAFE_SPEED);
    ...
    private void ConeLiftDrop(){
        ...
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-1830);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-1830);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()+1830);
        RightFront.setTargetPosition(RightFront.getCurrentPosition()+1830);
        ...
        LeftBack.setTargetPosition(LeftBack.getCurrentPosition()-200);
        LeftFront.setTargetPosition(LeftFront.getCurrentPosition()-200);
        RightBack.setTargetPosition(RightBack.getCurrentPosition()-200);
